...
class InformationManagerTest {
    ...
    /**
     * testDuplicateDriver: Method to test if driver is duplicate when adding a new Driver, should return true if driver is not duplicate.
     */
    @Test
    ...
    /**
     * testUpdateDriverById: Method to test if a Driver can be successfully updated
     */
    @Test
    ...
    /**
     * Method to test if a race can be added with a null driver, should return assertation
     */
    @Test
