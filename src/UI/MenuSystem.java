...
public class MenuSystem {
    ...
    /**
     * start: Method to start the menu system, returns true if the user chooses to exit
     *
     * @return boolean
     */
    ...
    /**
     * handleDriversMenu: Provides a Drivers Menu, allowing the user to view, add, update, delete, and load drivers from a file. Returns the user's choice to the main menu.
     *
     * @param scanner
     * @return int
     */
    ...
    /**
     * handleRacesMenu: Handles the Race Menu, allowing the user to view, add, update, delete, and load races from a file. Returns the user's choice to the main menu.
     *
     * @param scanner
     * @return int
     */
    ...
    /**
     * runProtectedAction: Method to run protected actions, with error handling to ensure the program continues running smoothly even if an action fails.
     *
     * @param actionName
     * @param action
     * @return int
    ...
    /**
     * showStandings: Method to show the championship standings, returns the number of drivers in the standings for confirmation.
     *
     * @return int
     */
    ...
    /**
     * addDriver: Method to add a Driver to file, returns true if successful, otherwise false.
     *
     * @param scanner
     * @return boolean
     */
    ...
    /**
     * updateDriver: Method to update a Driver in file, returns true if successful, otherwise false.
     *
     * @param scanner
     * @return boolean
     */
    ...
    /**
     * deleteDriver: Method to delete a Driver from file, returns true if successful, otherwise false.
     *
     * @param scanner
     * @return boolean
     */
    ...
    /**
     * addRace: Method to add a Race to file, returns true if successful, otherwise false.
     *
     * @param scanner
     * @return boolean
     */
    ...
    /**
     * updateRace: Method to update a Race in file, returns true if successful, otherwise false.
     *
     * @param scanner
     * @return boolean
     */
    ...
    /**
     * saveToFile: Method to save and auto-save data to a file, returns true if successful, otherwise false.
     *
     * @param scanner
     * @return boolean
     */
    ...
    /**
     * autoSaveCurrectData: Method to auto-save current data to a file, returns 1 if successful, otherwise -1.
     *
     * @return int
     */
    ...
    /**
     * autoSaveAfterChange: Method to auto-save data after changes, providing feedback to the user about the auto-save status.
     *
     * @param changeType
     */
    ...
    /**
     * promptDriver: Method to prompt the Driver's information from the user, returns a Driver object with the provided information.
     *
     * @param scanner
     * @param action
     * @return Driver
    ...
    /**
     * promptRace: Method to prompt the Race information from the user, returns a Race object with the provided information.
     *
     * @param scanner
     * @param action
     * @return
    ...
    /**
     * readExistingDriverOrNone: Method to read an existing Driver's ID from the user and return the corresponding Driver object, ensuring that the driver exists before proceeding.
     *
     * @param scanner
     * @return Driver
     */
    ...
    /**
     * readMenuChoice:Method to read a menu choice from the user, ensuring that the input is a valid positive integer, and returns the parsed integer value.
     *
     * @param scanner
     * @param prompt
    ...
    /**
     * readNonEmptyLine: Method to read a non-empty string from the user, ensuring that the input is valid and not empty, and returns the trimmed string value.
     *
     * @param scanner
     * @param prompt
     * @param allowNumbers
    ...
    /**
     * readBoolean: Method to read a boolean value from the user, ensuring that the input is either "true" or "false", and returns the corresponding boolean value.
     *
     * @param scanner
     * @param prompt
     * @return
    ...
    /**
     * Method to start action, returns action interface
     */
